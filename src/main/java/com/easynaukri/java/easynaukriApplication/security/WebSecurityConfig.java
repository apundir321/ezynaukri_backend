...
import com.easynaukri.java.easynaukriApplication.security.jwt.JwtAuthenticationEntryPoint;
import com.easynaukri.java.easynaukriApplication.security.jwt.JwtRequestFilter;
...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        .antMatchers(HttpMethod.GET,"/getRecruiterProfilePic/**").permitAll()
